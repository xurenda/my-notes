---
date: 2023-11-01 17:46
modified: 2025-06-30 10:54
---

**源**：[https://segmentfault.com/a/1190000013378197](https://segmentfault.com/a/1190000013378197)
...
Vue1._ 支持内置的过滤器，但是Vue2._ 就不再内置过滤器，但是支持自定义过滤器。
1、过滤器的创建和使用
```
1.创建
   Vue.filter(
