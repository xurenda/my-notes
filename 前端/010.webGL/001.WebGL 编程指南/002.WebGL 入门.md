...
```js
<canvas id="canvas" width="400" height="400">当前浏览器不支持 Canvas<canvas>
...
![[Pasted image 20240815133315.png]]
...
- `initShaders`：在 WebGL 系统内部建立和初始化着色器
	...
	- 行为：![[Pasted image 20240815135359.png]]
...
![[Pasted image 20240815152640.png]]
...
![[Pasted image 20240815192346.png]]
...
![[Pasted image 20240815192012.png]]
...
function click(event, gl, a_Position) {
  ...
  let x = evnet.clientX // 鼠标点击处的 x 坐标
  let y = evnet.clientY // 鼠标点击处的 y 坐标
