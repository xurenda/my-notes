...
可以先阅读 [[011.网页字体度量及渲染|网页字体度量及渲染]] 了解字体度量，帮助理解本章节
...
[W3C 文档](https://www.w3.org/TR/css-fonts-4/#font-metrics-override-desc) 中的介绍并不明确，具体计算方式见下表。Ascent / Descent / Line Gap / em 的取值见：[[011.网页字体度量及渲染|网页字体度量及渲染]]
