...
- `property` 标签： 可以给 setter 方法对应的属性赋值
    ...
    #### 4.2.3 实验三： IoC容器创建和使用
      1. 介绍
          ...
          ![](https://secure2.wostatic.cn/static/ngQZT7qhVfAzTxrr2oX1ny/image.png)
...
```
    ...
    #### 4.2.5 实验五： 高级特性：FactoryBean特性和使用
      1. FactoryBean简介
          ...
          ![](https://secure2.wostatic.cn/static/5yNzfRW9TqkASMuJafu6Pa/image.png)
      2. FactoryBean使用场景
          1. 代理类的创建
          2. 第三方框架整合
          3. 复杂对象实例化等
...
```
    ...
    #### 4.2.6 实验六： 基于XML方式整合三层架构组件
      1. 需求分析
          ...
          ![](https://secure2.wostatic.cn/static/dMe3en4EMVQ5JEi3PVDjae/image.png)
      2. 数据库准备
