...
[[006.浏览器缓存#Service Worker|Service Worker]] 的目的在于离线缓存，转发请求和网络代理。
...
SharedWorker 是 [[009.Web Worker|Web Worker]] 的一种，多个页面共享一个 SharedWorker
