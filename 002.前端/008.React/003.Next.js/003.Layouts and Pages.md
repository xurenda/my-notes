...
您可以使用 `<Link>` 组件在路由之间导航。`<Link>` 是一个内置的 Next.js 组件，它扩展了 HTML `<a>` 标签以提供[[004.链接和导航#预取 (Prefetching)|预取]]和[客户端导航](https://nextjs.org/docs/app/getting-started/linking-and-navigating#client-side-transitions)
