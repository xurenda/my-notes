...
> 队头阻塞问题其实在 [[017.HTTP 各版本差异|HTTP 各版本差异]] 中已经写的很详细了，本文再单独拿出来说一下
...
[WebTransport](https://developer.mozilla.org/zh-CN/docs/Web/API/WebTransport) 可以理解为基于 HTTP/3 的 [[019.WebSocket|WebSocket]]
