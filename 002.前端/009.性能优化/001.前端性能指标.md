...
modified: 2025-07-24 18:00
---

# 性能衡量模型

Chrome 提出了 [RAIL](https://web.dev/rail/) 性能衡量模型，[以用户为中心的效果指标](https://web.dev/articles/user-centric-performance-metrics?hl=zh-cn)，RAIL 代表 Web 应用生命周期的四个不同方面：响应、动画、空闲和加载
