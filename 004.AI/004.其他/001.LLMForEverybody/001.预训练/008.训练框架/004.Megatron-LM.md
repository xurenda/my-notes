---
date: 2025-08-25 20:38
modified: 2025-08-25 20:42
---
...
![[Pasted image 20250825203945.png]]
...
2. **克隆 Megatron-LM 仓库**：`git clone https://github.com/NVIDIA/Megatron-LM.git`
3. **安装 Megatron-LM**：在克隆的仓库目录中，安装 Megatron-LM 的依赖项：`pip install -r requirements.txt`
...
1. **安装 Megatron-LM 和 Accelerate**：`pip install megatron-lm accelerate`
2. **准备环境**：
...
截至本文完稿时（2024/10/14），Accelerate 对 Megatron-LM 的支持主要在 DP 上，Accelerate 暂时没有 PP 和 TP
